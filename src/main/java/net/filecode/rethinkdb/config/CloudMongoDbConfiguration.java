package net.filecode.rethinkdb.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import net.filecode.rethinkdb.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("net.filecode.rethinkdb.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("net.filecode.rethinkdb.config.dbmigrations");
