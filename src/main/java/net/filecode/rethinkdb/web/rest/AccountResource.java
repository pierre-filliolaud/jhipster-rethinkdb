...
import net.filecode.rethinkdb.domain.PersistentToken;
...
import net.filecode.rethinkdb.service.MailService;
import net.filecode.rethinkdb.service.UserService;
import net.filecode.rethinkdb.service.dto.UserDTO;
import net.filecode.rethinkdb.web.rest.vm.KeyAndPasswordVM;
import net.filecode.rethinkdb.web.rest.vm.ManagedUserVM;
import net.filecode.rethinkdb.web.rest.util.HeaderUtil;
