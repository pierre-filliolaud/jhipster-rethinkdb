package net.filecode.rethinkdb.web.rest;

import net.filecode.rethinkdb.RethinkdbApp;
import net.filecode.rethinkdb.config.audit.AuditEventConverter;
import net.filecode.rethinkdb.domain.PersistentAuditEvent;
import net.filecode.rethinkdb.repository.PersistenceAuditEventRepository;
import net.filecode.rethinkdb.service.AuditEventService;
...
@SpringBootTest(classes = RethinkdbApp.class)
